        ...
        <section class="section section-sm">
            <div class="container">
                ...
                <div class="row row-30 justify-content-center box-ordered">
                    <?php
                    include "public/config/connection.php";
                    $query1 = mysqli_query($connect, "SELECT * FROM traveling as t join daerah as d on t.id_daerah = d.id_nama_daerah 
                    where t.id_daerah = '$_GET[id_nama_daerah]' order by RAND()");
                        ...
                        <div class="col-sm-6 col-md-5 col-lg-3">
                            ...
                            <article class="team-modern">
                                ...
                                <div class="team-modern-caption">
                                    <h6 class="team-modern-name"><a href="#"><?php echo $data2['nama_tempat'] ?></a></h6>
                                </div>
                            </article>
                        </div>
                    <?php } ?>
